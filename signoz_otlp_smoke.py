        ...
        "resourceSpans": [
            {
                ...
                "scopeSpans": [
                    {
                        "scope": {"name": "manual-otlp-smoke"},
                        "spans": [
                            {
                                "traceId": hex_id(32),
                                "spanId": hex_id(16),
                                "name": "first-signoz-smoke-test",
                                "kind": 2,
                        ...
                        "logRecords": [
                            {
                                ...
                                "severityNumber": 9,
                                "body": {
                                    "stringValue": random.choice(messages)
                                },
                                "attributes": [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        send_log()
        send_metric()
        print(f"Sent smoke telemetry for service.name={SERVICE_NAME}")
        if not loop:
            break
        time.sleep(interval)
